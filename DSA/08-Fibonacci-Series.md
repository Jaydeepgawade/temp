...
This workbook develops a complete understanding of **Fibonacci Series**.
...
The central idea is to store two neighboring terms, print the current term, and calculate the next term from their sum.
...
static List<long> Fibonacci(int count)
{
    ...
    {
        result.Add(first);
        (first, second) = (second, checked(first + second));
    }
    return result;
}
```
...
## Solved Problem 1: Fibonacci Series case 1
...
2. Apply the rule: store two neighboring terms, print the current term, and calculate the next term from their sum.
...
```csharp
Console.WriteLine(string.Join(", ", Fibonacci(1)));
```
...
## Solved Problem 2: Fibonacci Series case 2
...
```csharp
Console.WriteLine(string.Join(", ", Fibonacci(2)));
```
...
## Solved Problem 3: Fibonacci Series case 3
...
## Solved Problem 4: Fibonacci Series case 4
...
## Solved Problem 5: Fibonacci Series case 5

### Requirement

Process the representative input `10` using the chapter algorithm.
Return or display the mathematically correct result.
Do not hide the logic inside an unrelated library shortcut.
Keep the algorithm in a separate method so it can be tested.
...
| Step | State inspected | Decision or calculation | Why it is correct |
|---:|---|---|---|
| 0 | Input is `10` | Initialize method state | No input work has been processed yet |
| 1 | Inspect state after update 1 | Apply the next valid part of the algorithm | The invariant remains true after this update |
| 2 | Inspect state after update 2 | Apply the next valid part of the algorithm | The invariant remains true after this update |
| 3 | Inspect state after update 3 | Apply the next valid part of the algorithm | The invariant remains true after this update |
| 4 | Inspect state after update 4 | Apply the next valid part of the algorithm | The invariant remains true after this update |
...
Revision note 1: Re-explain the Fibonacci Series invariant using a new input.
Revision note 2: Re-explain the Fibonacci Series invariant using a new input.
Revision note 3: Re-explain the Fibonacci Series invariant using a new input.
Revision note 4: Re-explain the Fibonacci Series invariant using a new input.
Revision note 5: Re-explain the Fibonacci Series invariant using a new input.
Revision note 6: Re-explain the Fibonacci Series invariant using a new input.
Revision note 7: Re-explain the Fibonacci Series invariant using a new input.
Revision note 8: Re-explain the Fibonacci Series invariant using a new input.
Revision note 9: Re-explain the Fibonacci Series invariant using a new input.
Revision note 10: Re-explain the Fibonacci Series invariant using a new input.
Revision note 11: Re-explain the Fibonacci Series invariant using a new input.
Revision note 12: Re-explain the Fibonacci Series invariant using a new input.
Revision note 13: Re-explain the Fibonacci Series invariant using a new input.
Revision note 14: Re-explain the Fibonacci Series invariant using a new input.
Revision note 15: Re-explain the Fibonacci Series invariant using a new input.
Revision note 16: Re-explain the Fibonacci Series invariant using a new input.
Revision note 17: Re-explain the Fibonacci Series invariant using a new input.
Revision note 18: Re-explain the Fibonacci Series invariant using a new input.
Revision note 19: Re-explain the Fibonacci Series invariant using a new input.
Revision note 20: Re-explain the Fibonacci Series invariant using a new input.
